...
use LaStudioKitThemeBuilder\Modules\FloatingButtons\Classes\Render\Contact_Buttons_Var_4_Render;
...
class Contact_Buttons_Var_4 extends Widget_Contact_Button_Base_Pro {
	...
	public static function get_configuration() {
		...
		$config['content']['chat_button_section']['section_name'] = esc_html__( 'Menu Button', 'lastudio-kit' );
		...
		$config['content']['chat_button_section']['chat_aria_label'] = esc_html__( 'Links', 'lastudio-kit' );
		...
		$config['content']['contact_section']['repeater']['tooltip_label'] = esc_html__( 'Tooltip', 'lastudio-kit' );
	...
	public function get_title(): string {
		return esc_html__( 'Vertical Links', 'lastudio-kit' );
	}
