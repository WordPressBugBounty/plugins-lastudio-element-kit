...
use LaStudioKitThemeBuilder\Modules\FloatingButtons\Classes\Render\Contact_Buttons_Var_7_Render;
...
class Contact_Buttons_Var_7 extends Widget_Contact_Button_Base_Pro {
	...
	public static function get_configuration() {
		...
		$config['content']['chat_button_section']['defaults']['number'] = esc_html__( '+1.212.555.7979', 'lastudio-kit' );
	...
	public function get_title(): string {
		return esc_html__( 'Mobile Bar', 'lastudio-kit' );
	}
