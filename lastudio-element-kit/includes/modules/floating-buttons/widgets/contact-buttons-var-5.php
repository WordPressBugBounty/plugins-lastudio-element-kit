...
use LaStudioKitThemeBuilder\Modules\FloatingButtons\Classes\Render\Contact_Buttons_Var_5_Render;
...
class Contact_Buttons_Var_5 extends Widget_Contact_Button_Base_Pro {
	...
	public static function get_configuration() {
		...
		$config['content']['chat_button_section']['chat_aria_label'] = esc_html__( 'Chat', 'lastudio-kit' );
	...
	public function get_title(): string {
		return esc_html__( 'Classic', 'lastudio-kit' );
	}
