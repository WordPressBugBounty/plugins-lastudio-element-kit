...
use LaStudioKitThemeBuilder\Modules\FloatingButtons\Classes\Render\Contact_Buttons_Var_10_Render;
...
class Contact_Buttons_Var_10 extends Widget_Contact_Button_Base_Pro {
	...
	public static function get_configuration() {
		...
		$config['style']['contact_section']['icon_color_label'] = esc_html__( 'Text and Icon Color', 'lastudio-kit' );
	...
	public function get_title(): string {
		return esc_html__( 'Interactive', 'lastudio-kit' );
	}
