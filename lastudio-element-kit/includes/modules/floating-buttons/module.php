...
namespace LaStudioKitThemeBuilder\Modules\FloatingButtons;

use Elementor\Core\Base\Module as BaseModule;
use Elementor\Core\Documents_Manager;
use Elementor\Plugin;
use Elementor\Utils as ElementorUtils;
use LaStudioKitThemeBuilder\Modules\FloatingButtons\Documents\Floating_Buttons;
...
class Module extends BaseModule {
	...
	public static function get_floating_elements_types() {
		return [
			'floating-buttons' => esc_html__( 'Floating Buttons', 'lastudio-kit' ),
			'floating-bars' => esc_html__( 'Floating Bars', 'lastudio-kit' ),
		];
	}
	...
	public function register_location( Locations_Manager $location_manager ) {
		$location_manager->register_location(
			'floating_buttons',
			[
				'label' => esc_html__( 'Floating Buttons', 'lastudio-kit' ),
				'multiple' => true,
				'public' => false,
