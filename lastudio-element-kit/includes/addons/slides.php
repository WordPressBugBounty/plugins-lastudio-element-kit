...
class LaStudioKit_Slides extends LaStudioKit_Base {
    ...
    protected function enqueue_addon_resources(){
        ...
        if(!lastudio_kit()->is_optimized_css_mode()){
          wp_register_style( $this->get_name(), lastudio_kit()->plugin_url( 'assets/css/addons/slides.min.css' ), [ 'lastudio-kit-base', 'e-swiper' ], lastudio_kit()->get_version() );
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'slides', [
            ...
            'data-slider_options' => wp_json_encode( $this->get_advanced_carousel_options() ),
            'dir' => $direction
        ] );
