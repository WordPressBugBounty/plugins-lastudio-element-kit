...
trait LaStudioKit_Base_Carousel_Trait {
    ...
    public function add_carousel_layout_controls( $params ) {
        ...
        $grid_rows = array_combine( range( 1, 6 ), range( 1, 6 ) );

        $slides_to_show_shared_settings = [
            'label' => esc_html__( 'Slides on display', 'lastudio-kit' ),
        ...
        $slides_to_scroll_shared_settings = [
            'label' => esc_html__( 'Slides on scroll', 'lastudio-kit' ),
            'type' => Controls_Manager::SELECT,
            'options' => [
                    '' => esc_html__( 'Default', 'lastudio-kit' ),
                ] + $slides_on_display,
        ...
        $this->add_responsive_control(
            'grid_rows',
            [
                'label' => esc_html__( 'Grid Rows', 'lastudio-kit' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                        '' => esc_html__( 'Default', 'lastudio-kit' ),
                ] + $grid_rows,
                'inherit_placeholders' => true,
                'frontend_available' => true,
                'content_classes' => 'elementor-control-field-select-small',
                'render_type' => 'template',
            ]
    ...
    public function add_carousel_settings_controls( $params = [] ) {
        ...
        $autoplay_shared_settings = [
            ...
            'default' => 'yes',
            'options' => [
                'yes' => esc_html__( 'On', 'lastudio-kit' ),
                'no' => esc_html__( 'Off', 'lastudio-kit' ),
            ],
            'frontend_available' => true,
        ];
        ...
        $this->add_responsive_control(
            'carousel_height',
            [
                'label' => esc_html__( 'Carousel Height', 'elementor' ),
                ...
                'selectors' => [
                    '{{WRAPPER}} .e-n-carousel.swiper-vertical' => 'height: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [ 'carousel_direction' => 'vertical' ],
            ]
        );
        ...
        $this->add_control(
            'autoplay_speed',
            [
                'label' => esc_html__( 'Scroll Speed', 'lastudio-kit' ) . ' (ms)',
        ...
        $infinite_shared_settings = [
            'label' => esc_html__( 'Infinite scroll', 'lastudio-kit' ),
            'type' => Controls_Manager::SWITCHER,
            'default' => 'yes',
            'options' => [
                'yes' => esc_html__( 'On', 'lastudio-kit' ),
        ...
        $this->add_control(
            'speed',
            [
                'label' => esc_html__( 'Transition Duration', 'lastudio-kit' ) . ' (ms)',
                'type' => Controls_Manager::NUMBER,
                'default' => 500,
                'render_type' => 'none',
                'frontend_available' => true,
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'ltr' => esc_html__( 'Left', 'lastudio-kit' ),
                    'rtl' => esc_html__( 'Right', 'lastudio-kit' ),
                ],
            ]
        );

        $offset_sides_shared_settings = [
            'label' => esc_html__( 'Offset Sides', 'lastudio-kit' ),
            'type' => Controls_Manager::SELECT,
            'default' => 'none',
            'separator' => 'before',
            'frontend_available' => true,
        ...
        $this->add_responsive_control(
            'offset_width',
            [
                'label' => esc_html__( 'Offset Width', 'lastudio-kit' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'frontend_available' => true,
                'condition' => [
    ...
    public function add_carousel_navigation_controls( $params = [] ) {
        $navigation_shared_settings = [
            'label' => esc_html__( 'Navigation', 'lastudio-kit' ),
        ];
        ...
        $this->add_control(
            ...
            [
                ...
                'label' => esc_html__( 'Previous Arrow', 'lastudio-kit' ),
                'condition' => [
                    'arrows' => 'yes',
                ],
                'separator' => 'before',
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__( 'Next Arrow', 'lastudio-kit' ),
                'condition' => [
                    'arrows' => 'yes',
                ],
            ]
    ...
    public function add_carousel_navigation_styling_controls( $params = [] ) {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'inside',
                'options' => [
                    'inside' => esc_html__( 'Inside', 'lastudio-kit' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'bullets' => esc_html__( 'Dots', 'lastudio-kit' ),
                    'fraction' => esc_html__( 'Fraction', 'lastudio-kit' ),
                    'progressbar' => esc_html__( 'Progress', 'lastudio-kit' ),
                ],
    ...
    public function add_carousel_pagination_style_controls( $params ) {
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__( 'Dots', 'lastudio-kit' ),
                'condition' => [
                    'pagination' => 'bullets',
                ],
            ]
        ...
        $this->add_control(
            'dots_position',
            [
                'label' => esc_html__( 'Space From slides', 'lastudio-kit' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'outside',
                'options' => [
                    'inside' => esc_html__( 'None', 'lastudio-kit' ),
                    'outside' => esc_html__( 'Custom', 'lastudio-kit' ),
                ],
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__( 'Fraction', 'lastudio-kit' ),
                'condition' => [
                    'pagination' => 'fraction',
                ],
            ]
    ...
    private function add_custom_pagination( string $css_prefix, string $pagination_type ) {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Custom Position', 'lastudio-kit' ),
                'type' => Controls_Manager::SWITCHER,
                'label_off' => esc_html__( 'Hide', 'lastudio-kit' ),
                'label_on' => esc_html__( 'Show', 'lastudio-kit' ),
                'condition' => [
    ...
    private function get_arrows_horizontal_navigation_controls(): array {
        $navigation_controls = [
            'start' => [
                'title' => is_rtl() ? esc_html__( 'End', 'lastudio-kit' ) : esc_html__( 'Start', 'lastudio-kit' ),
            ...
            'end' => [
                'title' => is_rtl() ? esc_html__( 'Start', 'lastudio-kit' ) : esc_html__( 'End', 'lastudio-kit' ),
